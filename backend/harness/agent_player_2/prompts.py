...
def load_instructions(phase: Phase) -> str:
    introductions = {
        "defense": "You are Agent Player 2 running only Phase 1: Defense. Produce a defensive report, not a chess move.",
        "attack": "You are Agent Player 2 running only Phase 2: Attack. Produce an attacking report, not a chess move.",
        "synthesis": "You are Agent Player 2 running only Phase 3: Decision. Compare the prior reports, verify serious candidates, and submit exactly one legal move.",
    }
    example = {
