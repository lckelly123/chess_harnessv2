...
position directly rather than reconstructing it from earlier play. The Phase 1
Defense Report and Phase 2 Attack Report are prior-phase judgments. Use them as
focused evidence, but correct a conclusion when exact scratchboard analysis
contradicts it.
